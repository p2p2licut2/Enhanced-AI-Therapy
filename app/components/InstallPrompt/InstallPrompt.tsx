...
export default function InstallPrompt() {
  ...
  useEffect(() => {
    ...
    const handleBeforeInstallPrompt = (e: Event) => {
      // IMPORTANT: Nu prevenim default action aici
      // e.preventDefault(); - NU APELĂM ASTA
    ...
    <div className={styles.installPrompt}>
      <div className={styles.installPromptContent}>
        <div className={styles.textContent}>
          <h3 className={styles.title}>Instalează Terapie AI</h3>
        ...
        <div className={styles.actions}>
          {isIOS ? (
            <div className={styles.iosInstructions}>
              <p>Apasă pe <strong>Partajează</strong> <span className={styles.shareIcon}>
